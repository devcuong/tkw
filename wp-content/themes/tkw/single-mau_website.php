...
<style>
#pnav .float-image {
	background: url(<?php $hinh_anh_demo =   
        get_post_meta(get_the_ID(), 'hinh_anh_demo', true);
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="heading price-box">
									<label>Giá: </label><span class="price"><?php $gia_mau_website =  get_post_meta(get_the_ID(), 'gia_mau_website', true);
                                    if(! empty($gia_mau_website))
                                        echo $gia_mau_website;
									?></span>
								</div>
								<div class="shotdes">
										<?php
